...
extern  my_bool _db_keyword_locked_(struct _db_code_state_ *, const char *, int);
...
#define DBUG_EXECUTE_IF_LOCKED(keyword,a1) \
        do {if (_db_keyword_locked_(0, (keyword), 1)) { a1 }} while(0)
#define DBUG_EVALUATE_LOCKED(keyword,a1,a2) \
        (_db_keyword_locked_(0,(keyword), 0) ? (a1) : (a2))
#define DBUG_EVALUATE_IF_LOCKED(keyword,a1,a2) \
        (_db_keyword_locked_(0,(keyword), 1) ? (a1) : (a2))
...
#define DBUG_EXECUTE_LOCKED(keyword,a1) do { } while(0)
#define DBUG_EXECUTE_IF_LOCKED(keyword,a1) do { } while(0)
#define DBUG_EVALUATE_LOCKED(keyword,a1,a2) do { } while(0)
#define DBUG_EVALUATE_IF_LOCKED(keyword,a1,a2) do { } while(0)
